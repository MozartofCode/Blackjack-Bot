...
# @Filename: Bot4.py
# This bot makes move decisions based on a random forest implementation given the dataset
# generated by bot1 (relatively larger dataset)
...
class Bot4:
    def __init__(self, money):
        ...
        model_path = os.path.join(current_dir, '../AI_Models/random_forest_model.pkl')
