...
# @Filename: Bot5.py
# This bot makes move decisions based on a decision tree given the dataset
# generated by player against the house (me) (smaller dataset)

import math
from AI_Models.Decision_Tree import predict_move
import pandas as pd
import joblib
import os
...
class Bot5:
    def __init__(self, money):
        ...
        model_path = os.path.join(current_dir, '../AI_Models/decision_tree_model.joblib')
